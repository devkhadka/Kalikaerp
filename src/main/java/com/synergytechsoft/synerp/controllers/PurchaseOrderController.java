...
import com.synergytechsoft.synerp.entities.StoreReceive;
import com.synergytechsoft.synerp.facades.PurchaseOrderFacade;
...
public class PurchaseOrderController implements Serializable {
    ...
    @EJB
    private com.synergytechsoft.synerp.facades.PurchaseOrderFacade ejbFacade;
    ...
    public static class PurchaseOrderControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof PurchaseOrder) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + PurchaseOrderController.class.getName());
            }
        }
    }
    private String poNo;
    ...
    public String doGetPurchaseOrderDetailsByPo() {

        purchaseOrder = getFacade().getPo(poNo);

        return "/foriegnPurchaseOrderRecieved/ForiegnPurchaseSave";
