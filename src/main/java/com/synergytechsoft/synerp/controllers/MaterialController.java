...
import com.synergytechsoft.synerp.facades.MaterialFacade;
...
public class MaterialController implements Serializable {
    ...
    @EJB
    private com.synergytechsoft.synerp.facades.MaterialFacade ejbFacade;
    ...
    public static class MaterialControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Material) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + MaterialController.class.getName());
            }
        }
    }
}
