...
import com.synergytechsoft.synerp.entities.Activity;
...
import com.synergytechsoft.synerp.facades.ActivityFacade;
...
public class ActivityController implements Serializable {
    ...
    @EJB
    private com.synergytechsoft.synerp.facades.ActivityFacade ejbFacade;
    ...
    public static class ActivityControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Activity) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ActivityController.class.getName());
            }
        }
    }
}
