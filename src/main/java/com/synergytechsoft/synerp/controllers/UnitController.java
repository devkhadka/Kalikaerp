...
import com.synergytechsoft.synerp.facades.UnitFacade;
...
public class UnitController implements Serializable {
    ...
    @EJB
    private com.synergytechsoft.synerp.facades.UnitFacade ejbFacade;
    ...
    public static class UnitControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Unit) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + UnitController.class.getName());
            }
        }
    }
}
